...
//!: 백엔드에서 telephone 파라미터를 요구하므로 임의로 'telephone' 파라미터를 추가해야 함.
//TODO: 백엔드 예외처리 로직 반영되면 throw Error 수정 필요
/**
 * 환자 회원가입을 위해 서버에 요청을 보냅니다.
 *
 * @param {Object} params - 회원가입 정보를 담은 객체로, 'username', 'password', 'passwordCheck', 'name', 'birthdate' 필드를 포함해야 합니다.
 ...
 * "/api/auth/signup/patient" 엔드포인트에 POST 요청을 보내 회원가입을 시도하고, 서버로부터 받은
