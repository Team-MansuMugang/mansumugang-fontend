...
const fetchPrescriptionList = async (patientId) => {
  const response = await fetch(`${baseURL}/api/medicine/prescription?patientId=${patientId}`, {
    headers: {
...
export default fetchPrescriptionList;
