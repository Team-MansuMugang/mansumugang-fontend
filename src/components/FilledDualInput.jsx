 ...
 * @returns {JSX.Element}
 */
const FilledDualInput = ({ placeholder = ['입력칸 1', '입력칸 2'], onInputChange }) => {
  ...
  return (
    <div className="dual-input">
      <input type="text" name="input1" placeholder={placeholder[0]} onChange={handleChange} />
      <input type="text" name="input2" placeholder={placeholder[1]} onChange={handleChange} />
    </div>
  );
};
